...
function ConfirmRidePopup(props: any) {
  ...
  return (
    <div className="h-screen">
      <h5
        ...
        className="p-1 text-center w-[93%]   absolate top-0"
      >
        <svg
      ...
      <div className="flex items-center justify-between p-3 bg-neutral-600/30 rounded-md mb-5">
      ...
      <div className="flex justify-between  gap-4 flex-col items-center">
        ...
        <Button
          ...
          variant={"outline"}
          className="w-full bg-neutral-500/60"
        >
          Accept
        </Button>
      </div>
